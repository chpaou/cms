            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.evenements.index')}}">Evénements</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.videos.index')}}">Vidéos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.photoaccueils.index')}}">Photos Accueil </a>
                        </li>
                        @endcan
                    </ul>
