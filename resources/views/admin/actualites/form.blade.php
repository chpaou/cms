        ...
        <div class="form-group row">
            ...
            <div class="col-md-12">
                <input id="titre" type="text" class="form-control @error('titre') is-invalid @enderror" name="titre"
                    autocomplete="off" value="{{ old('titre', $actualite->titre ?? null) }}" required>
            ...
            <div class="col-md-12">
                <div class="custom-control custom-radio">
                    <input type="radio" class="custom-control-input" id="enligne" name="enligne" value="1"
                        {{ ($actualite->enligne ?? null) == true ? 'checked' : ''}} required>
                ...
                <div class="custom-control custom-radio mb-3">
                    <input type="radio" class="custom-control-input" id="enligne2" name="enligne" value="0"
                        {{ ($actualite->enligne ?? null) == false ? 'checked' : '' }} required>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="file" name="profile_image" id="profile_image" class="form-control-file"
                        id="exampleFormControlFile1" value="{{ old('filename', $actualite->filename ?? null) }}">
                    <span class="text-danger"> {{ $errors->first('profile_image') }}</span>
                </div>
                @if ($actualite ?? '' && $actualite->filename)
                <img src="/profile_images/{{ $actualite->filename }}" class="img-fluid img-thumbnails">
                @endif
            </div>
        </div>
    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-12">
                <textarea class="form-control contenu" name="contenu" cols="30" rows="10"
                    id="contenu">{{ old('contenu', $actualite->contenu ?? null) }}</textarea>
